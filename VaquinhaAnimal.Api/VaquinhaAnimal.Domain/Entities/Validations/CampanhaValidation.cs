    ...
    public class CampanhaValidation : AbstractValidator<Campanha>
    {
        ...
        public CampanhaValidation()
        {
            ...
            RuleFor(c => c.DuracaoDias)
                .NotNull().WithMessage("O campo {PropertyName} precisa ser fornecido")
                .GreaterThanOrEqualTo(30).WithMessage("Sua campanha deve durar no mínimo de 30 dias")
                .LessThanOrEqualTo(120).WithMessage("Sua campanha deve durar no máximo de 120 dias");
